      ...
      <div className='flex-flex-col justify-center'>
        <div className='grid md:grid-cols-3 gap-4 border-gray-300 border px-2 py-2 rounded-xl mb-5'>
          {data.map((ele: any, index) => {
            ...
            if (ok) {
              return (
                <div key={index} className='flex flex-col items-center justify-center order-gray-300 border px-2 py-2 rounded-xl gap-4'>
                  ...
                  <div className='flex flex-col gap-4'>
                    ...
                    <p className='text-gray-400'>{ele.description.slice(0, 45)}...</p>
                    <p>Price: {ele.price}</p>
                    <Link to={`/product/${ele.id}`} className='bg-red-300 border border-gray-500 rounded-xl py-2 px-4'>
                      See More...
                    </Link>
                  </div>
                </div>
